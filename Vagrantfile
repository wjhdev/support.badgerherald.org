...
Vagrant.configure("2") do |config|
  ...
  ## Provision
  config.vm.provision :shell, path: "config/provision.sh", args: "support.badgerherald.org.test", privileged: false
  ...
  # Mount vagrant 
  config.vm.synced_folder ".", "/home/vagrant/support.badgerherald.org", :group => "www-data", :mount_options => ['dmode=775','fmode=664']
