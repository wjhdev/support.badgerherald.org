  ...
  render() {
    return (
      ...
      <wp-router query={this.query}>
        <wp-template definition={ { type : Template.TemplateType.FrontPage, frontPageType: Template.FrontPageType.Page  } } component="bhaa-front-page"></wp-template>
        ...
        <wp-template definition={ { type : Template.TemplateType.PageNotFound} }  component="bhaa-404"></wp-template>
        <wp-template definition={ { type : Template.TemplateType.Blog} }  component="bhaa-updates"></wp-template>
      </wp-router>,
